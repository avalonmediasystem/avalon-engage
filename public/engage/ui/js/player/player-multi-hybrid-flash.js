...
function AC_AddExtension(src, ext)
{
  ...
  else
  {
    ...
    function AC_Generateobj(objAttrs, params, embedAttrs)
    {
        ...
        if (playerType === "/engage/ui/embed.html")
        {
            ...
            {
                str = '<input id="oc_image" type="image" src="" alt="Video Player" title="Click to start" />';
  ...
  return ret;
    ...
    if (hasProductInstall && !hasRequestedVersion)
    {
		...
		var alternateContent = 'This player requires Adobe Flash Player.<br>' + 'Please install latest version for your OS.<br>(Version 10.1 or later) ' + '<a href="http://www.adobe.com/go/getflash/">Get Flash</a>';
